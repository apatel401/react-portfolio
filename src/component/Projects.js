  ...
  const pickComponent = () => {
    switch (activeComp) {
      case "1":
        ...
        break;
      case "2":
        return <DragDropMatching config="./widgets/drag-and-drop-matching/matching.json" id="2"/>;
        break;
      case "3":
        return <Flowchart config="./widgets/flowchart/flowchart2.json" id="3" />;
        break;
      case "4":
        return  <Flashcards config="./widgets/flashcards/config.json" id="4" />;
        break;
      case "5":
        return <Flashcards config="./widgets/flashcards/config2.json" id="5" />;
        break;
      case "6":
        return <Flashcards config="./widgets/flashcards/config3.json" id="6" />;
        break;
      case "7":
        return <Flashcards config="./widgets/flashcards/config3.json" id="7" />;
        break;
      case "8":
        return <Flashcards config="./widgets/flashcards/config3.json" id="8" />;
        break;
      case "9":
      ...
      */}
      <ul className="component-btn">
        {CompDisplay.map((component) => {
          return <li key={component.id}><button onClick={() => switchComp(component)}>{component.name}</button></li>;
        })}
      </ul>
